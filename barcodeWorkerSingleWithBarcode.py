...
def main(instance):
    ...
    fileLocations=instance[0]
    sampleName=instance[1]
    ...
    # print information
    print('\t Detected number of fragments in {}: {}.'.format(sampleName,totalNumberOfFragments))
    ...
    if barcode in readSequenceR1:
        ...
        if max(x) == -1:
            ...
            if len(trimmedR1) >= fragmentThresholdLength:
                ...
                acceptableFragments['case.1a'].append([[readNameR1,trimmedR1,trimmedR1quality],[]])
        else:
    ...
    if barcode in readSequenceR2:
        ...
        if max(x) == -1:
            ...
            if len(trimmedR2) >= fragmentThresholdLength:
                ...
                acceptableFragments['case.1b'].append([[],[readNameR2,trimmedR2,trimmedR2quality]])
        else:
            doubleCounts.append(readNameR1)
    ...
    if reverseComplementBarcode in readSequenceR1:
        ...
        if max(x) == -1:
            ...
            if len(trimmedR1) >= fragmentThresholdLength:
                ...
                acceptableFragments['case.2a'].append([[readNameR1,trimmedR1,trimmedR1quality],[]])
        else:
            doubleCounts.append(readNameR1)
    ...
    if reverseComplementBarcode in readSequenceR2:
        ...
        if max(x) == -1:
            ...
            if len(trimmedR2) >= fragmentThresholdLength:
                ...
                acceptableFragments['case.2b'].append([[],[readNameR2,trimmedR2,trimmedR2quality]])
        else:
            doubleCounts.append(readNameR1)
